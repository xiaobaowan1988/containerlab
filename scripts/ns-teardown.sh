...
for node in spine1 tor1 tor2 worker1 worker2 external w1pod1 w2pod1; do
...
for link in vlsp1tr1 vlsp1tr2 vltr1wk1 vltr2wk2 vlsp1ext vethw1pod1 vethw2pod1; do
